...
public class StatisticsCounter {
    ...
    public record Result(
        ...
        public static Result combine(Result r1, Result r2) {
            r1.totalSpendPerBuyer.keySet().stream().map(
                    k1 -> r2.totalSpendPerBuyer.merge(k1, r1.totalSpendPerBuyer.get(k1), Long::sum));
            r1.totalSellCountPerCategory.keySet().stream().map(
                    k1 -> r2.totalSellCountPerCategory.merge(k1, r1.totalSellCountPerCategory.get(k1), Integer::sum));
            r1.totalSellCountPerProduct.keySet().stream().map(
                    k1 -> r2.totalSellCountPerProduct.merge(k1, r1.totalSellCountPerProduct.get(k1), Integer::sum));
            return new Result(r2.totalSpendPerBuyer, r2.totalSellCountPerProduct, r2.totalSellCountPerCategory, r1.totalProfit + r2.totalProfit);
        }
